...
class VAEVisualize(BaseVisualize):
    ...
    def recons(self, x_input,x_labels, x_recons, z_recons, num_samples_to_plot=5):

        f, axarr = plt.subplots(num_samples_to_plot, 2, figsize=self.fig_size)
